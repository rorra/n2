...
Clone this application to your machine and checkout  stable release 3.4.2

        git clone git://github.com/newscloud/n2.git
        git checkout --track -b stable_release origin/stable_release

Alternatively, download release 3.4.2 directly [http://github.com/newscloud/n2/archives/v3.4.2_stable](http://github.com/newscloud/n2/archives/v3.4.2_stable)
