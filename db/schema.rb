...
ActiveRecord::Schema.define(:version => 20111026003847) do
  ...
  add_index "feeds", ["enabled"], :name => "index_feeds_on_enabled"
  ...
  add_index "gos", ["cached_slug"], :name => "index_gos_on_cached_slug"
  add_index "gos", ["goable_type", "goable_id"], :name => "index_gos_on_goable_type_and_goable_id"
  add_index "gos", ["name"], :name => "index_gos_on_name"
  add_index "gos", ["user_id"], :name => "index_gos_on_user_id"
